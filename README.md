...
# Қазақ тіліне арналған бенчмарк сұрақтары

Бұл репозиторий жасанды интеллект (ЖИ) модельдерінің қазақ тілін қаншалықты жақсы меңгергенін тексеруге арналған бенчмарк сұрақтарын қамтиды. Сұрақтар әдебиет, тарих, лингвистика және география сияқты әртүрлі тақырыптарды қамтиды.

## 📌 Сұрақтар санаттары

1. **Қазақ әдебиеті мен мәдениеті**  
2. **Қазақ тарихы**  
3. **Лингвистикалық сұрақтар**  
4. **Қазақ тілінің ерекшеліктері**  
5. **Қазақстан географиясы**  

Барлық сұрақтар [`kazakh_questions.txt`](kazakh_questions.txt) файлында сақталған. Бұл файл ЖИ модельдерінің қазақ тілін және мәдениетін қаншалықты дұрыс түсінетінін тексеру үшін қолданылады.

## 📄 Файл құрылымы

- `kazakh_questions.txt` – Қазақ тіліндегі сұрақтар тізімі.  

## 🚀 Қалай қолдануға болады?

1. Қазақ тілі бойынша ЖИ модельдерін тексеріңіз.  
2. Әртүрлі модельдердің нәтижелерін салыстырыңыз.  
3. Қазақ тіліне қатысты әлсіз тұстарды анықтаңыз.  
